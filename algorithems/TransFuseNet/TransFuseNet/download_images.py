...
REMOTE_DIR = "input4"
LOCAL_DIR = r"F:\DJ\TransFuseNet\TransFuseNet\input_images"  # 最终监听目录
TEMP_DIR = r"F:\DJ\TransFuseNet\TransFuseNet\temp_download"  # 新增临时下载目录
MAX_SIZE_MB = 6  # 压缩阈值（MB）
COMPRESSION_QUALITY = 70  # JPEG压缩质量（0-100）
