...
数据使用npz格式,利用npz.py脚本将图片格式数据转换为npz格式
/home/ahu/桌面/file/TransFuseNet/TransFuseNet/data/Synapse目录下新建train_npz和test_vol_h5文件夹
其中train_npz文件夹存放训练文件
test_vol_h5文件夹存放测试文件
再修改TransFuseNet/TransFuseNet/lists/lists_Synapse路径下txt文件
...
### 5. Test
TransFuseNet/TransFuseNet/model/TU_Synapse224路径下存放训练好的权重,可识别高压线塔