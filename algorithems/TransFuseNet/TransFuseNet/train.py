...
parser.add_argument('--root_path', type=str,
                    default='/home/ahu/桌面/file/TransFuseNet/TransFuseNet/data/Synapse/train_npz', help='root dir for data')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            'root_path': '/home/ahu/桌面/file/TransFuseNet/TransFuseNet/data/Synapse/train_npz',
    ...
    snapshot_path = "/home/ahu/桌面/file/TransFuseNet/TransFuseNet/model/{}/{}".format(args.exp, 'TU')
