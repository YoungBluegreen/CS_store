...
const telemetry = computed(() => [
  { label: '高度', value: '120', unit: 'm' },
  { label: '速度', value: '8.2', unit: 'm/s' },
  { label: '航向', value: '327', unit: 'deg' },
  { label: '电量', value: '72', unit: '%' },
  { label: '风速', value: '3.1', unit: 'm/s' },
...
function issueCommand (label: string) {
  ...
  roll.value = label === '返航' ? 4 : label === '飞向目标' ? -12 : -8
  pitch.value = label === '起飞' ? -6 : label === '悬停' ? 8 : 10
}
