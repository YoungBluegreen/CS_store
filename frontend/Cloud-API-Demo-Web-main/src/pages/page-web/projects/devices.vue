...
<template>
  ...
  <div class="device-table-wrap table flex-display flex-column">
    ...
    <a-modal v-model:visible="deleteTip" width="450px" :closable="false" centered :okButtonProps="{ danger: true }" @ok="unbind">
        <p class="pt10 pl20" style="height: 50px;">确定要从当前工作空间移除该设备吗？</p>
        <template #title>
...
const columns: ColumnProps[] = [
  ...
  { title: '绑定时间', dataIndex: 'bound_time', width: 150, sorter: (a: Device, b: Device) => a.bound_time.localeCompare(b.bound_time), className: 'titleStyle' },
