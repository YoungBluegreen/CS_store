              ...
              <a-col span="6">
                <a-tooltip>
                  <template #title>
                    ...
                    <p>已用：{{ deviceInfo.dock.basic_osd?.storage?.used  }}</p>
                  </template>
              ...
              <a-col span="6">
                <a-tooltip>
                  <template #title>
                    ...
                    <p>已用：{{ deviceInfo.device?.storage?.used  }}</p>
                  </template>
                  <span><FolderOpenOutlined /></span>
