<template>
  <div class="header">
    ...
    <a-radio-group v-model:value="activePanel" button-style="solid">
      <a-radio-button value="tasks">任务列表</a-radio-button>
      <a-radio-button value="planner">航线规划器</a-radio-button>
    </a-radio-group>
  </div>
  <div class="plan-panel-wrapper">
    <a-table v-if="activePanel === 'tasks'" class="plan-table" :columns="columns" :data-source="plansData.data" row-key="job_id"
...
import WaylinePlannerPanel from './WaylinePlannerPanel.vue'

const store = useMyStore()
const workspaceId = localStorage.getItem(ELocalStorageKey.WorkspaceId)!
const activePanel = ref<'tasks' | 'planner'>('tasks')
